...
export default function Home() {
  const videoIds = ["E_ODj4TrG9g", "2etgnaNvOT8", "xf1SdvA-6V0"];
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative w-full h-[80vh]">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-red-900/60 via-black/60 to-red-900/60 backdrop-blur-[2px] flex flex-col items-center justify-center text-white text-center px-4 md:px-8">
          ...
          >
            Fei Tian Dancers (FTD) is a community of University of California,
            Berkeley students passionate about dance and dedicated to presenting
            Chinese culture to the Bay Area.
          </motion.p>
        </div>
      </div>
      ...
      <section className="py-12 px-4 md:px-8 lg:px-16 bg-white">
        <h2 className="text-5xl font-script mb-8 text-jujube">
          Past Performance
        </h2>
