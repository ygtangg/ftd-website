					...
					<div className="md:w-1/2 flex flex-col items-center text-center">
						...
						<div className="space-y-1">
							<p className="italic text-lg mb-4">
								Join us to experience the elegance of classical, Han-Tang, Dai, and
								Dunhuang group pieces, alongside a vibrant array of solo, duet, and
								trio performances highlighting the rich diversity of Chinese dance
								styles!{" "}
							</p>
							<p>May 11, 2025</p>
							<p>1:00 - 3:00 PM</p>
