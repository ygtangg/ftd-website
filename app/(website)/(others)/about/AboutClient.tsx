			...
			<section className="flex flex-col md:flex-row py-8 px-4 md:px-8">
				...
				>
					...
					<p className="text-center leading-relaxed mb-6">
						We are the one & only Chinese dance team at UC Berkeley. Established in 2003
						as a Registered Student Organization, FTD supports dancers of all
						backgrounds in developing their Chinese dance skill & technique, enhancing
						their comprehension of traditional Chinese culture, & in spreading greater
						awareness of Chinese classical & ethnic cultures to the bigger community.
						FTD incorporates classical, ethnic, & modern Chinese dances into its
						repertoire through creating original choreography & learning traditional
						works, performing on campus & throughout the Bay Area.
					</p>
				</motion.div>
